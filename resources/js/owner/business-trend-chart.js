                    ...
                    .map((item, index) => {
                        ...
                        return `
                            <div class="admin-chart-tooltip-row">
                                ...
                                <span class="admin-chart-tooltip-value">${escapeHtml(formatValue(value, item.format))}</span>
                            </div>
                        `;
                    })
                    .join('');
        ...
        responsive: [
            {
                ...
                options: {
                    ...
                    xaxis: { labels: { showDuplicates: false, style: { fontSize: '10px' } } },
                    grid: { padding: { top: 8, right: 4, bottom: 0, left: -6 } },
                },
            },
        ],
    };
