...
<div data-chatbot-root data-chatbot-config="platinumGymMemberChatbotConfig" data-chatbot-variant="member">
    ...
    <div class="fixed inset-x-3 bottom-3 z-[45] flex flex-col items-end sm:bottom-6 sm:left-auto sm:right-6 sm:w-fit sm:max-w-[calc(100vw-3rem)]" style="padding-bottom: env(safe-area-inset-bottom);">
        <section id="gymmi-member-panel" data-chatbot-panel hidden tabindex="-1" role="dialog" aria-modal="true" aria-hidden="true" aria-labelledby="member-chatbot-title" class="mx-auto h-[min(620px,calc(100dvh-1.5rem))] w-full flex-col overflow-hidden overscroll-contain rounded-2xl border border-zinc-200 bg-white shadow-[0_18px_60px_rgba(24,24,27,0.14)] focus:outline-none focus-visible:ring-2 focus-visible:ring-gold-700/45 dark:border-zinc-800 dark:bg-zinc-950 dark:shadow-2xl dark:focus-visible:ring-gold-400/45 sm:h-[min(560px,calc(100dvh-6rem))] sm:w-[25rem]">
            <header class="flex shrink-0 items-center justify-between gap-3 border-b border-zinc-200 bg-zinc-50 px-4 py-3 text-zinc-950 dark:border-zinc-800 dark:bg-white/[0.04] dark:text-zinc-100">
                <div class="flex min-w-0 items-center gap-3">
                    ...
                    <div class="min-w-0">
                        <h2 id="member-chatbot-title" class="truncate text-sm type-title">Gymmi</h2>
            ...
            <div class="shrink-0 border-t border-zinc-200 px-3 py-3 dark:border-zinc-800">
                ...
                <div class="flex gap-2">
                    <input type="text" name="gymmi_member_message" data-chatbot-input class="member-form-input h-11 min-w-0 flex-1 text-base" placeholder="Ketik pertanyaan..." aria-label="Ketik pertanyaan untuk Gymmi" minlength="2" maxlength="700" autocomplete="off" spellcheck="true">
        ...
        <button type="button" data-chatbot-trigger class="gymmi-trigger" aria-label="Buka Gymmi member" aria-controls="gymmi-member-panel" aria-expanded="false">
            <img
