            ...
            @foreach ($classSchedules as $schedule)
                ...
                <article class="rounded-lg border border-zinc-200 bg-white p-4 transition hover:border-gold-500/50 hover:shadow-[0_18px_48px_rgba(254,172,24,0.10)] dark:border-white/10 dark:bg-zinc-950/45">
                    ...
                    <x-confirm-form
                        ...
                        method="POST"
                        :message="(! $isFull && $confirmMessage) ? $confirmMessage : ''"
                    ...
                    >
                        <label class="block">
                            ...
                            <input
                                ...
                                class="mt-2 min-h-11 w-full rounded-lg border border-zinc-200 bg-white px-3 text-sm font-bold text-zinc-900 shadow-sm focus:border-gold-500 focus:outline-none focus:ring-2 focus:ring-gold-500/20 dark:border-white/10 dark:bg-zinc-950 dark:text-white"
                                @disabled($isFull)
                            >
                        </label>
