    ...
    <section class="public-section">
        <div class="public-container">
            <div class="public-card mx-auto max-w-3xl space-y-6 text-sm leading-7 text-zinc-600 dark:text-zinc-300">
                <section>
                    <h2 class="mb-2 text-base type-control text-zinc-950 dark:text-zinc-100">Akun Member</h2>
                ...
                <section>
                    <h2 class="mb-2 text-base type-control text-zinc-950 dark:text-zinc-100">Kewajiban Pengguna</h2>
                ...
                <section>
                    <h2 class="mb-2 text-base type-control text-zinc-950 dark:text-zinc-100">Pembayaran dan Layanan</h2>
                ...
                <section>
                    <h2 class="mb-2 text-base type-control text-zinc-950 dark:text-zinc-100">Perubahan Ketentuan</h2>
