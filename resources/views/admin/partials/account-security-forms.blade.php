...
<section class="admin-card mb-6">
    <div class="flex min-w-0 flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div class="flex min-w-0 items-center gap-4">
            <div class="grid h-16 w-16 shrink-0 place-items-center overflow-hidden rounded-xl border border-gold-500/25 bg-gold-500 text-2xl type-emphasis text-zinc-950" aria-hidden="true">
                @if ($adminAvatarUrl)
            ...
            <div class="min-w-0">
                ...
                <h2 class="mt-1 break-words text-xl type-title text-zinc-950 dark:text-zinc-100">{{ $adminName }}</h2>
