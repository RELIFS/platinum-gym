    ...
    <section class="admin-page-header">
        <div class="flex flex-col gap-5 lg:flex-row lg:items-start lg:justify-between">
            ...
            <dl class="grid min-w-0 gap-3 sm:grid-cols-3 lg:w-[28rem]">
                ...
                <div class="admin-panel p-3">
                    <dt class="text-[0.72rem] font-black uppercase tracking-[0.14em] text-zinc-500 dark:text-zinc-400">Peran</dt>
        ...
        <section class="admin-card">
            <div class="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
                <div>
                    ...
                    <h2 class="mt-2 text-xl font-black text-zinc-950 dark:text-white">Akses cepat</h2>
                </div>
    ...
    <section class="admin-card mt-6">
        <div class="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
            <div>
                ...
                <h2 class="mt-2 text-xl font-black text-zinc-950 dark:text-white">Aktivitas terbaru</h2>
        ...
        <div class="mt-5 grid gap-4 xl:grid-cols-2">
            <div class="admin-panel">
                <div class="flex items-start justify-between gap-3">
                    <h3 class="text-base font-black text-zinc-950 dark:text-white">Member terbaru</h3>
                    <a href="{{ route('admin.members') }}" class="text-sm font-black text-gold-600 underline-offset-4 hover:underline dark:text-gold-400">Lihat member</a>
                </div>
            ...
            <div class="admin-panel">
                <div class="flex items-start justify-between gap-3">
                    <h3 class="text-base font-black text-zinc-950 dark:text-white">Pembayaran terbaru</h3>
                    <a href="{{ route('admin.payments') }}" class="text-sm font-black text-gold-600 underline-offset-4 hover:underline dark:text-gold-400">Lihat pembayaran</a>
                </div>
                <div class="mt-4 space-y-3">
