<x-guest-layout>
    <div class="w-full">
        <a href="{{ route('login') }}" class="mb-8 inline-flex items-center gap-2 rounded-lg px-1 py-2 text-sm font-semibold text-zinc-500 transition hover:text-gold-600 dark:text-zinc-400 dark:hover:text-gold-500">
        ...
        <div class="mb-8">
            ...
            <h2 class="mb-3 text-3xl font-extrabold leading-tight text-zinc-950 dark:text-white">
                Aktivasi <span class="text-gold-500">Akun</span>
            </h2>
        ...
        @error('token')
            <div class="mb-5 rounded-lg border border-red-500/30 bg-red-500/10 p-4 text-sm font-bold text-red-700 dark:text-red-300" role="alert">{{ $message }}</div>
        @enderror
