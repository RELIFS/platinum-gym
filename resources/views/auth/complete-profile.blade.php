    ...
    <div class="w-full">
        ...
        <form method="POST" action="{{ route('member.profile.complete.store') }}" class="space-y-5">
            ...
            <div>
                ...
                <input id="phone" class="auth-input" type="tel" name="phone" value="{{ old('phone', Auth::user()->phone) }}" required autocomplete="tel" placeholder="08xxxxxxxxxx" maxlength="20" inputmode="tel" data-phone-feedback-input aria-describedby="phone-feedback">
