    ...
    <div class="fixed bottom-3 right-3 z-50 flex w-fit max-w-[calc(100vw-1.5rem)] flex-col items-end sm:bottom-6 sm:right-6" style="padding-bottom: env(safe-area-inset-bottom);">
        <section data-chatbot-panel hidden tabindex="-1" role="dialog" aria-modal="true" aria-hidden="true" aria-labelledby="chatbot-title" class="mx-auto flex h-[min(620px,calc(100dvh-1.5rem))] w-[calc(100vw-1.5rem)] flex-col overflow-hidden overscroll-contain rounded-2xl border border-zinc-800 bg-zinc-950 shadow-2xl focus:outline-none focus-visible:ring-2 focus-visible:ring-gold-500/50 sm:h-[min(560px,calc(100dvh-6rem))] sm:w-96">
            <header class="flex shrink-0 items-center justify-between gap-3 bg-gold-500 px-4 py-3 text-zinc-950">
                ...
                <button type="button" data-chatbot-close class="inline-flex h-11 w-11 shrink-0 touch-manipulation items-center justify-center rounded-full text-zinc-950 transition hover:bg-zinc-950/10 focus:outline-none focus-visible:ring-2 focus-visible:ring-zinc-950/30" aria-label="Tutup chatbot">
                    <svg class="h-5 w-5" viewBox="0 0 20 20" fill="none" aria-hidden="true">
            ...
            <div class="shrink-0 border-t border-zinc-800 px-3 py-3">
                ...
                <div class="flex gap-2">
                    <input type="text" data-chatbot-input class="public-input h-11 min-w-0 flex-1 border-zinc-700 bg-zinc-900 text-base text-zinc-100 placeholder:text-zinc-500" placeholder="Ketik pertanyaan..." aria-label="Ketik pertanyaan chatbot">
                    <button type="button" data-chatbot-send class="inline-flex h-11 w-11 shrink-0 touch-manipulation items-center justify-center rounded-full bg-gold-500 text-zinc-950 transition hover:bg-gold-400 focus:outline-none focus-visible:ring-2 focus-visible:ring-gold-500/60 disabled:cursor-not-allowed disabled:opacity-50" aria-label="Kirim pesan chatbot" disabled>
