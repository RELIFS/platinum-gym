        ...
        <section data-chatbot-panel hidden tabindex="-1" role="dialog" aria-modal="true" aria-hidden="true" aria-labelledby="chatbot-title" class="mx-auto h-[min(620px,calc(100dvh-1.5rem))] w-full flex-col overflow-hidden overscroll-contain rounded-2xl border border-zinc-200 bg-white shadow-[0_18px_60px_rgba(24,24,27,0.14)] focus:outline-none focus-visible:ring-2 focus-visible:ring-gold-500/50 dark:border-zinc-800 dark:bg-zinc-950 dark:shadow-2xl sm:h-[min(560px,calc(100dvh-6rem))] sm:w-[25rem]">
            ...
            <div class="shrink-0 border-t border-zinc-200 px-3 py-3 dark:border-zinc-800">
                ...
                <div class="flex gap-2">
                    <input type="text" name="gymmi_public_message" data-chatbot-input class="public-input h-11 min-w-0 flex-1 text-base" placeholder="Ketik pertanyaan..." aria-label="Ketik pertanyaan untuk Gymmi" autocomplete="off" spellcheck="true">
                ...
                <a data-chatbot-escalation href="{{ $chatbotConfig['whatsappUrl'] }}" target="_blank" rel="noopener noreferrer" class="mt-3 inline-flex min-h-11 w-full touch-manipulation items-center justify-center break-words rounded-full border border-zinc-200 px-4 py-2 text-center text-xs font-bold text-zinc-700 transition hover:border-gold-500/60 hover:text-gold-700 focus:outline-none focus-visible:ring-2 focus-visible:ring-gold-500/30 dark:border-zinc-700 dark:text-zinc-300 dark:hover:text-gold-400">
                    Lanjut WhatsApp Admin
                </a>
            </div>
        </section>

        <button type="button" data-chatbot-trigger class="gymmi-trigger" aria-label="Buka Gymmi">
            <img
