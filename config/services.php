...
return [
    ...
    */
    ...
    'gemini' => [
        ...
        'normalizer_enabled' => env('GYMMI_AI_NORMALIZER_ENABLED', true),
        'normalizer_min_confidence' => env('GYMMI_AI_NORMALIZER_MIN_CONFIDENCE', 60),
        'normalizer_max_output_tokens' => env('GYMMI_AI_NORMALIZER_MAX_OUTPUT_TOKENS', 260),
